...
function NewsletterVerifySuccess() {
  ...
  return (
    <>
      <Helmet>
        <title>{t('newsletter.verify.success.title')}</title>
        <meta
          property="og:title"
          content={t('newsletter.verify.success.ogTitle')}
        />
        <meta
          property="og:description"
          content={t('newsletter.verify.success.ogDesc')}
        />
      </Helmet>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <h1 className="mb-4 text-3xl font-bold">
          {t('newsletter.verify.success.heading')}
        </h1>
        <p className="mb-6 max-w-md text-sm text-gray-700 sm:text-base">
          {t('newsletter.verify.success.description')}
        </p>
        <a
          href="/"
...
export default NewsletterVerifySuccess
